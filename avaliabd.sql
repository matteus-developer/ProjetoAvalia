...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21/10/2025 às 03:03
...
CREATE TABLE `provaquestao` (
  `idProvaQuestao` int(11) NOT NULL,
  `idQuestao` int(11) NOT NULL,
  `idProva` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `provaquestao` (`idProvaQuestao`, `idQuestao`, `idProva`) VALUES
(1, 1, 1);
...
ALTER TABLE `provaquestao`
  ADD PRIMARY KEY (`idProvaQuestao`),
  ADD KEY `fk_idProvaQuestao` (`idQuestao`),
  ADD KEY `fk_idQuestaoProva` (`idProva`);
...
--
-- AUTO_INCREMENT de tabela `provaquestao`
--
ALTER TABLE `provaquestao`
  MODIFY `idProvaQuestao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `provaquestao`
  ADD CONSTRAINT `fk_idProvaQuestao` FOREIGN KEY (`idQuestao`) REFERENCES `questao` (`idQuestao`),
  ADD CONSTRAINT `fk_idQuestaoProva` FOREIGN KEY (`idProva`) REFERENCES `prova` (`idProva`);
COMMIT;
